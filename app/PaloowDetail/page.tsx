...
const PaloowDetail = () => {
  return (
    <div>
      ...
      <p>The projects goal was to create an ecosystem where users can manage their finances, expand their knowledge, invest smartly, and enjoy easy purchasing, all with a single login and profile.</p>
